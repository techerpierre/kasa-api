...
func CreatePasswordRepository() *PasswordRepository {
...
func (s *PasswordRepository) Hash(password string) (string, *entities.Exception) {
...
func (*PasswordRepository) decodeHash(encodedHash string) (*params, []byte, []byte, error) {
...
func (*PasswordRepository) generateRandomBytes(n uint32) ([]byte, error) {
	b := make([]byte, n)
	_, err := rand.Read(b)
